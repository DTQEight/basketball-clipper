...
- **独立片段预览 + 人工确认**：每个检测到的进球生成独立 480p 预览片段，逐个查看后勾选保留/删除
...
- **可视化界面**：Gradio 界面，卡片式布局，实时标定、参数调节、结果预览
...
4. 点击「开始检测」→ 生成每个进球的独立预览片段
5. 下拉选择某个进球查看预览，勾选要保留的进球
6. 点击「确认保留」删除未勾选的片段
7. 点击「生成集锦」→ 输出原画质集锦 mp4
